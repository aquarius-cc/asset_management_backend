...
urlpatterns = [
    ...
    path('audit-logs/by-logging-id/<str:logging_id>/', AuditLogByLoggingIdView.as_view(), name='audit-log-by-logging-id'),
    ...
    path('audit-logs/by-operator/<str:operator_jobcode>/', AuditLogsByOperatorView.as_view(), name='audit-log-by-operator'),
]
