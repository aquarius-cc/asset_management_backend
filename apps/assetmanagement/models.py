...
# from apps.assetmanagement.querysets import (
#     AssetQuerySet,
#     BrokenAssetQuerySet,
#     DamagedAssetQuerySet,
#     FoundAssetQuerySet,
#     LostAssetQuerySet,
#     OutAssetQuerySet,
#     RecycleAssetQuerySet,
#     WasteAssetQuerySet,
# )
...
#     # 【重构】recordcode 字段已提升到 BaseModel
...
#     # 【重构】save() 中的 recordcode 生成逻辑已提升到 BaseModel
...
#         help_text="最终验收的日期"
#     )
#     contract_settledment_status = models.CharField(
#         max_length=20,
...
#             models.Index(fields=["contract_settledment_status"]),
#         ]
...
#     #         base = today.strftime("%Y%m%d") + timezone.now().strftime("%H%M%S")
#     #         extra = str(uuid.uuid4().hex)[:8].upper()
#     #         self.recordcode = f"{prefix}{base}{extra}"
...
#             # 资产状态查询通过 Asset 表的 asset_current_status 索引查询
...
#     # 回收后仓库通过 recycle_asset.asset_storage_code 关联查询
#     # 回收时直接更新 Asset 表的 asset_storage_code 字段
#     # 【AGENTS 规范 - 去除冗余】recycle_asset_using_person_jobcode 删除
#     # 使用人信息通过 recycle_asset.asset_manager_jobcode 关联查询
...
#     def __str__(self) -> str:
#         return f"待报废{self.asset_recordcode.asset_name}"
...
#         indexes = [
#             models.Index(fields=["asset_recordcode"]),
#             models.Index(fields=["damaged_recordcode"]),  # 【新增】来源记录索引
#         ]
...
#     def __str__(self) -> str:
#         return f"硬盘SN-{self.harddisk_sn_code} {self.asset_recordcode.asset_name}"
...
#         help_text="资产损坏的原因"
#     )
#     broken_description = models.TextField(
#         verbose_name="损坏描述",
#         blank=True,
#         null=True,
#         help_text="损坏的详细描述"
...
#     objects = SoftDeleteManager.from_queryset(BrokenAssetQuerySet)()
#     all_objects = models.Manager()
