...
from apps.assetmanagement.operation_log_service import OperationLogQueryService
...
class TestLoggingIdUniqueness:
    ...
    def test_duplicate_logging_id_raises_error(self):
        ...
        log1 = AssetOperationLog.objects.create(
            asset_code="TEST001",
            operation_type="create",
            description="测试1"
        )
    ...
    def test_two_records_have_different_logging_ids(self):
        ...
        log2 = AssetOperationLog.objects.create(
            asset_code="TEST002",
            operation_type="create",
            description="测试2"
        )
...
class TestGetByLoggingIdService:
    ...
    def test_nonexistent_logging_id(self):
        ...
        result = OperationLogQueryService.get_operation_log_by_logging_id(
            "nonexistent-Log-20250123-A1B2C3D4"
        )
