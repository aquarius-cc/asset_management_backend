...
class TestAssetSelector:
    ...
    def test_get_available_assets(self, asset):
        ...
        assert available.first().asset_type_code.asset_type_code == 'AT001'
    ...
    def test_get_assets_by_status(self, asset):
        ...
        assert in_store_assets.first().asset_type_code.asset_type_code == 'AT001'
    ...
    def test_get_asset_by_code(self, asset):
        ...
        assert result.asset_type_code.asset_type_code == 'AT001'
    ...
    def test_search_assets(self, asset):
        ...
        assert results.first().asset_type_code.asset_type_code == 'AT001'
    ...
    def test_search_assets_by_status(self, asset):
        ...
        assert all(a.asset_type_code.asset_type_code == 'AT001' for a in results)
