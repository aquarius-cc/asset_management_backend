...
def public_scan_view(request: Request, recordcode: str) -> Response:
    ...
    data = {
        ...
        "asset_storage_name": (
            asset.asset_storage_recordcode.storage_name
            if asset.asset_storage_recordcode else None
        ),
        "asset_type_name": (
            asset.asset_type_recordcode.type_name
            if asset.asset_type_recordcode else None
        ),
        "asset_manager_name": (
            asset.asset_manager_recordcode.employee_name
            if asset.asset_manager_recordcode else None
        ),
